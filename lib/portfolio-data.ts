...
## Projects
1. **Portfolio Website** — Clean, responsive personal portfolio (HTML/CSS/JS)
   - Live: https://iamtati1.github.io/iamtati.github.io/
   - GitHub: https://github.com/iamtati1/iamtati.github.io

2. **Pokédex Explorer** — API-driven app with search and filter functionality
   - Live: https://tati-uremu-mls.github.io/mod-4-project/
   - GitHub: https://github.com/tati-uremu-mls/mod-4-project

3. **CLI Quiz Game** — Interactive quiz app using core JavaScript principles
   - GitHub: https://github.com/iamtati1/swe-project-1-cli-app-v2

4. **Recipe Card App** — Responsive layout using Flexbox and CSS Grid
